        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_1 = _a.sent();
                        throw new Error("Could not index users: " + err_1);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_2 = _a.sent();
                        throw new Error("Could not show user " + err_2);
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    UserStore.prototype.create = function (first_name, last_name, username, password, isAdmin) {
        return __awaiter(this, void 0, void 0, function () {
            var conn, cols, sql, hash, result, err_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 1:
                        conn = _a.sent();
                        cols = 'first_name, last_name, username, password, is_admin';
                        sql = "INSERT INTO users (" + cols + ") VALUES ($1, $2, $3, $4, $5) RETURNING *";
                        hash = bcrypt_1.default.hashSync(password + process.env.BCRYPT_PASSWORD, parseInt(process.env.SALT_ROUNDS));
                        return [4 /*yield*/, database_1.default.query(sql, [
                                first_name,
                                last_name,
                                username,
