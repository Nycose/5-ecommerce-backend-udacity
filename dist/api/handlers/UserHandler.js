...
var create = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, first_name, last_name, username_1, password, is_admin, users, newUser, token, error_3;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 5, , 6]);
                _a = req.body, first_name = _a.first_name, last_name = _a.last_name, username_1 = _a.username, password = _a.password, is_admin = _a.is_admin;
                return [4 /*yield*/, store.index()];
            case 1:
                users = _b.sent();
                if (!users.find(function (u) { return u.username === username_1; })) return [3 /*break*/, 2];
...
var login = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, username, password, login_1, error_4;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
            ...
            case 1:
                login_1 = _b.sent();
                return [2 /*return*/, res.send(login_1)];
            case 2:
                error_4 = _b.sent();
...
exports.UserController.get('/', index);
exports.UserController.get('/:userid', show);
exports.UserController.post('/', create);
exports.UserController.post('/login', login);
