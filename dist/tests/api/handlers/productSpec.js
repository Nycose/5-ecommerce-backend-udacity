...
var ProductModel_1 = require("../../../api/models/ProductModel");
var products = new ProductModel_1.ProductStore();
var users = new UserModel_1.UserStore();
var request = (0, supertest_1.default)(app_1.default);
describe('/products endpoint responses', function () {
